...
func init() {
	flag.IntVar(&n, "n", 1, "n 回以上連続してタイムアウトした場合にサーバー故障とみなす")
	flag.IntVar(&m, "m", 1, "直近 m 回の平均応答時間が t ミリ秒を超えた場合にサーバー過負荷状態とみなす")
	flag.IntVar(&t, "t", 100, "直近 m 回の平均応答時間が t ミリ秒を超えた場合にサーバー過負荷状態とみなす")
}
